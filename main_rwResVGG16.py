...
from keras_model import get_rwResVGG16model
import h5py
import time
...
def main(params, network_params):
    ...
    for fold_cnt in range(params['nb_folds']):
        ...
        data_splitter_cls.rawprepare(fold_n=fold_cnt, run_type='train')
        data_splitter_cls.rawprepare(fold_n=fold_cnt, run_type='val')
        data_splitter_cls.rawprepare(fold_n=fold_cnt, run_type='test')
        ...
        model = get_rwResVGG16model(params, network_params)
